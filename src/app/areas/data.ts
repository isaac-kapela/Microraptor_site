...
export const areas: Area[] = [
  ...
  },
  {
    ...
    description:
      'A área de Fuselagem e Laminação é responsável pela fabricação do corpo principal da aeronave e das peças em materiais compostos. A equipe trabalha com fibra de carbono e fibra de vidro usando técnicas como laminação a vácuo e infusão de resina, garantindo estruturas leves, resistentes e geometricamente precisas.',
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'A área de Cauda é responsável pela fabricação das empenagens horizontal e vertical da aeronave. A equipe garante que os perfis projetados pela Aerodinâmica sejam reproduzidos com fidelidade, com geometria correta, baixo peso e instalação precisa das superfícies de controle (profundor e leme).',
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'A área de Asa é responsável pela fabricação da asa principal da aeronave. É a superfície mais crítica do projeto: qualquer desvio geométrico impacta diretamente o desempenho aerodinâmico. A equipe reproduz com precisão o perfil definido pela Aerodinâmica, instalando ailerons e garantindo o menor peso possível.',
    responsibilities: [
      'Fabricação da asa principal',
      'Corte de perfis aerodinâmicos (nervuras) em CNC',
      'Revestimento com balsa, film ou compósitos',
      'Instalação dos ailerons e dobradiças',
